...
<div id="header">
    <ul id="nav1">
        <li>
            <?php
                include(__DIR__ . '/logas.php');
            ?>
        </li>
        <li>
            <a href="./">Retour au site www2-int.semantic.lu</a>
        </li>
    </ul>
    ...
    <img id="middleLogo" src="./static/images/logo-cairn-int.png" alt="CAIRN.INFO : International Edition.">
