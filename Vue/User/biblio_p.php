...
$this->titre = "Ma bibliographie - Imprimer";
...
<div id="copy">
    <table width="70%" cellspacing="0" cellpading="0" >
        <tr>
            <td width="200px"><img src="./static/images/CAIRN_INFO.png"></td><td>
                <p class="titresel">S&eacute;lection bibliographique<br /><span class="refsel"><?php echo $dates .' , ' . $hours ?></span></p>
            </td>
        </tr>
    </table>
</div>
...
<p class="biblio">
    <ul>
        ...
        foreach($articles as $article)
        {
            ...
            {
                $articleString.= ' à ' . $article['ARTICLE_PAGE_FIN'] . '.';
            }            
