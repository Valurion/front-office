...
function getFactureAbo($idCommande, $commandeTmp, $arrayAbos, $prices, $tauxTVA, $tauxTVAreduit){
    ...
    $str = '<html>
            ...
            <td colspan=2 style="width:330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Abonnement acheté en ligne</td>
    ...
    foreach($arrayAbos as $abo){
        ...
        $str .= '<tr>
            ...
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;"><br>Revue : <em>'.$abo['TITRE'].'</em><br><br> Formule : '.$abo['INFOSUP'].'<br><br>'.$abo['LIBELLE'].'<br><br><br><br><br><br><br><br><br><br>'.$idCommande.'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;"><br>'.$abo['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;"><br>'.$abo['PRIX_HT'].' €</td>
            </tr>';
    }
