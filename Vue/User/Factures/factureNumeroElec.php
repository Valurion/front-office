...
function getFactureNumeroElec($idCommande, $commandeTmp, $arrayNums, $prices, $tauxTVA, $tauxTVAreduit){
    ...
    foreach($arrayNums as $num){
        $str .= '<tr>
            ...
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;"><br>Revue : <em>'.$num['REVUE_TITRE'].'</em><br><br> Numéro '.$num['NUMERO_ANNEE'].'/'.$num['NUMERO_NUMERO'].'<br><br>Titre : '.$num['NUMERO_TITRE'].'<br><br>Version électronique<br><br><br><br><br><br><br><br>'.$idCommande.'</td>
