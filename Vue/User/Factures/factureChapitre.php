...
function getFactureChapitre($idCommande, $commandeTmp, $arrayArt, $prices, $tauxTVA, $tauxTVAreduit){
    ...
    foreach($arrayArt as $art){
        $str .= '<tr>
            ...
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;"><br>Contribution : <em>'.$art['ARTICLE_TITRE'].'</em><br><br> in : '.$art['NUMERO_TITRE'].'<br><br><br><br><br><br><br><br><br><br>ID article : '.$art['ARTICLE_ID_ARTICLE'].' - Commande n°'.$idCommande.'</td>
