...
function getFactureNumero($idCommande, $commandeTmp, $arrayNums, $prices, $tauxTVA, $tauxTVAreduit){
    ...
    $str = '<html>
            ...
            <td colspan=2 style="width:330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Numéro acheté en ligne</td>
    ...
    foreach($arrayNums as $num){
        ...
        $str .= '<tr>
            ...
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;"><br>Revue : <em>'.$num['REVUE_TITRE'].'</em><br><br> Numéro '.$num['NUMERO_ANNEE'].'/'.$num['NUMERO_NUMERO'].'<br><br>Titre :'.$num['NUMERO_TITRE'].'<br><br>'.($isCE?'dont':'+').' Frais de port: '.$num['FP'].' €<br><br><br><br><br><br><br><br>'.$idCommande.'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;"><br>'.$num['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;"><br>'.$num['PRIX_HT'].' €</td>
            </tr>';
    }
