...
function getFactureCredit($idCommande, $commandeTmp, $arrayCredits, $prices, $tauxTVA, $tauxTVAreduit){
    ...
    $str = '<html>
            ...
            <td colspan=2 style="width:330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Crédit d\'articles acheté en ligne</td>
    ...
    foreach($arrayCredits as $credit){
        $str .= '<tr>
            ...
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;"><br><em>Crédit pour l\'achat d\'articles, de contributions, de chapitres d\'ouvrages, de numéros de revue ou d\'abonnement sur le site www.cairn.info.</em>
                <br><br> Date d\'expiration : '.$credit['EXPIRATION_CREDIT'].'<br><br><br><br><br><br><br><br><br><br><br><br>Commande n° '.$idCommande.'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;"><br>'.$credit['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;"><br>'.$credit['PRIX_HT'].' €</td>
            </tr>';
    }
