...
function getFactureAchats($idCommande, $commandeTmp, $arrayArts, $arrayNums, $arrayNumsElec, $arrayAbos, $arrayCredits, $prices, $tauxTVA, $tauxTVAreduit){
    ...
    foreach($arrayCredits as $credit){
        $str .= '<tr>
            ...
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;"><em>Crédit pour l\'achat d\'articles, de contributions, de chapitres d\'ouvrages, de numéros de revue ou d\'abonnement sur le site www.cairn.info.</em>
                <br>Date d\'expiration : '.$credit['EXPIRATION_CREDIT'].'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$credit['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$credit['PRIX_HT'].' €</td>
            </tr>';
     }
    foreach($arrayArts as $art){
        if($art['REVUE_TYPEPUB'] == 1){
           $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Article : <em>'.$art['ARTICLE_TITRE'].'</em><br>Revue : '.$art['REVUE_TITRE'].', n° '.$art['NUMERO_ANNEE'].'/'.$art['NUMERO_NUMERO'].'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$art['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$art['PRIX_HT'].' €</td>
            </tr>';
        }else if($art['REVUE_TYPEPUB'] == 2){
            $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Article : <em>'.$art['ARTICLE_TITRE'].'</em><br>Magazine : '.$art['REVUE_TITRE'].', n° '.$art['NUMERO_ANNEE'].'/'.$art['NUMERO_NUMERO'].'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$art['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$art['PRIX_HT'].' €</td>
            </tr>';
        }else{
            $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Contribution : <em>'.$art['ARTICLE_TITRE'].'</em><br> in : '.$art['NUMERO_TITRE'].'</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$art['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$art['PRIX_HT'].' €</td>
            </tr>';
        }
    ...
    foreach($arrayNumsElec as $num){
        if($num['REVUE_TYPEPUB'] == 1 || $num['REVUE_TYPEPUB'] == 2){
            $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Revue : <em>'.$num['REVUE_TITRE'].'</em><br> Numéro '.$num['NUMERO_ANNEE'].'/'.$num['NUMERO_NUMERO'].'<br>Titre :'.$num['NUMERO_TITRE'].'<br>(Achat électronique seulement)</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['PRIX_HT'].' €</td>
            </tr>';
        }else{
            $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Revue : <em>'.$num['NUMERO_TITRE'] .'</em><br>(Coll. "'. $num['REVUE_TITRE'] .'")<br>(Achat électronique seulement)</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['PRIX_HT'].' €</td>
            </tr>';
        }
    ...
    foreach($arrayNums as $num){
        if($num['REVUE_TYPEPUB'] == 1 || $num['REVUE_TYPEPUB'] == 2){
            $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Revue : <em>'.$num['REVUE_TITRE'].'</em><br> Numéro '.$num['NUMERO_ANNEE'].'/'.$num['NUMERO_NUMERO'].'<br>Titre :'.$num['NUMERO_TITRE'].'<br>'.($isCE?'dont':'+').' Frais de port: '.$num['FP'].' €</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['PRIX_HT'].' €</td>
            </tr>';
        }else{
            $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Revue : <em>'.$num['NUMERO_TITRE'] .'</em><br>(Coll. "'. $num['REVUE_TITRE'] .'")<br>'.($isCE?'dont':'+').' Frais de port: '.$num['FP'].' €</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$num['PRIX_HT'].' €</td>
            </tr>';
        }
    ...
    foreach($arrayAbos as $abo){
        $str .= '<tr>
            <td class="descomp" width="15%" style="font-family: \'Trebuchet MS\'; font-size:10pt;"> </td>
            <td class="comp" valign=top colspan=2 style="width: 330px; font-family: \'Trebuchet MS\'; font-size:10pt;">Revue : <em>'.$abo['TITRE'].'</em><br> Formule : '.$abo['INFOSUP'].'<br>'.$abo['LIBELLE'].'<br>'.($isCE?'dont':'+').' Frais de port: '.$abo['FP'].' €</td>
            <td align=center valign=top style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$abo['TAUX_TVA'].' %</td>
            <td valign=top align=right style="font-family: \'Trebuchet MS\'; font-size:10pt;">'.$abo['PRIX_HT'].' €</td>
            </tr>';
    }
    $str .= '<tr>
