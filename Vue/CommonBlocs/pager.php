        ...
        <ul>
            ...
            if ($currentPage != 1) {
                if (!isset($urlPager) || $urlPager == '') {
                    ?>
                    <li class="prev"><a href="javascript:void(0)" onclick="<?php echo $jsPager; ?>(<?php echo $limit - $nbPerPage; ?>)">Précédent</a></li>
                    <li class="first"><a href="javascript:void(0)" onclick="<?php echo $jsPager; ?>(0)">1</a></li>    
                    <?php
                } else {
                    ?>
                    <li class="prev"><a href="<?php echo $urlPager; ?>&amp;LIMIT=<?php echo $limit - $nbPerPage; ?>">Précédent</a></li>
            ...
            if ($currentPage != $lastPage) {
                if (!isset($urlPager) || $urlPager == '') {
                    ...
                    <li class="next"><a href="javascript:void(0)" onclick="<?php echo $jsPager; ?>(<?php echo $limit + $nbPerPage; ?>)">Suivant</a></li>
                    <?php
                } else {
                    ?>
                    <li class="last"><a href="<?php echo $urlPager; ?>&amp;LIMIT=<?php echo ($lastPage - 1) * $nbPerPage ?>"><?php echo $lastPage; ?></a></li>
                    <li class="next"><a href="<?php echo $urlPager; ?>&amp;LIMIT=<?php echo $limit + $nbPerPage; ?>">Suivant</a></li>
                        <?php
                    }
                }
                ?>
